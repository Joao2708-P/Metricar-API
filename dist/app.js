...
var errorHandlerMiddleware_default = errorHandlerMiddleware;
...
var limiter = (0, import_express_rate_limit.default)({
  ...
  // 15 minutos
  max: 100
  // Limite cada IP a 100 requisições por "window" (aqui, por 15 minutos)
});
app.use(errorHandlerMiddleware_default);
app.use(limiter);
